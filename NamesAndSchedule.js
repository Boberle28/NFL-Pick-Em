...
let week9 = new Week(9, "2025-10-31T00:15:00Z", "2025-11-04T03:15:00Z");
...
week1.AddGame(DET, NO);
week1.AddGame(TEN, NYJ);
week1.AddGame(IND, BAL);
week1.AddGame(PIT, ATL);
week1.AddGame(CAR, CHI);
week1.AddGame(JAX, CLE);
week1.AddGame(HOU, BUF);
week1.AddGame(LV, MIA);
week1.AddGame(MIN, GB);
week1.AddGame(PHI, WAS);
week1.AddGame(LAC, ARI);
...
week2.AddGame(TEN, PHI);
week2.AddGame(NE, PIT);
week2.AddGame(NYJ, GB);
week2.AddGame(TB, CLE);
week2.AddGame(BAL, NO);
week2.AddGame(HOU, CIN);
week2.AddGame(DEN, JAX);
week2.AddGame(LAC, LV);
week2.AddGame(DAL, WAS);
week2.AddGame(ARI, SEA);
week2.AddGame(SF, MIA);
...
week3.AddGame(DET, NYJ);
week3.AddGame(IND, HOU);
week3.AddGame(MIA, KC);
week3.AddGame(NYG, TEN);
week3.AddGame(PIT, CIN);
week3.AddGame(WAS, SEA);
week3.AddGame(JAX, NE);
week3.AddGame(SF, ARI);
week3.AddGame(TB, MIN);
week3.AddGame(DAL, BAL);
week3.AddGame(NO, LV);
...
week4.AddGame(CHI, NYJ);
week4.AddGame(CIN, JAX);
week4.AddGame(NYG, ARI);
week4.AddGame(PHI, LAR);
week4.AddGame(TB, GB);
week4.AddGame(BAL, TEN);
week4.AddGame(HOU, DAL);
week4.AddGame(MIN, MIA);
week4.AddGame(LV, KC);
week4.AddGame(SF, DEN);
week4.AddGame(SEA, LAC);
...
week5.AddGame(MIA, CIN);
week5.AddGame(NE, LV);
week5.AddGame(NO, MIN);
week5.AddGame(NYJ, CLE);
week5.AddGame(PIT, IND);
week5.AddGame(WAS, NYG);
week5.AddGame(LAC, DEN);
week5.AddGame(GB, CHI);
week5.AddGame(ARI, DET);
week5.AddGame(SEA, SF);
...
week6.AddGame(CLE, BAL);
week6.AddGame(IND, TEN);
week6.AddGame(NE, NYJ);
week6.AddGame(NYG, NO);
week6.AddGame(PHI, CAR);
week6.AddGame(TB, PIT);
week6.AddGame(LAR, ARI);
week6.AddGame(KC, LAC);
week6.AddGame(LV, BUF);
...
week7.AddGame(TEN, CLE);
week7.AddGame(MIN, IND);
week7.AddGame(NYJ, MIA);
week7.AddGame(CAR, TB);
week7.AddGame(BAL, CIN);
week7.AddGame(HOU, NYG);
week7.AddGame(ARI, DEN);
week7.AddGame(DET, GB);
week7.AddGame(LV, LAR);
...
week8.AddGame(DAL, ARI);
week8.AddGame(DET, MIN);
week8.AddGame(NYJ, LV);
week8.AddGame(PIT, CLE);
week8.AddGame(TB, ATL);
week8.AddGame(JAX, IND);
week8.AddGame(LAR, LAC);
week8.AddGame(DEN, KC);
week8.AddGame(MIA, NE);
...
week9.AddGame(KC, NYJ);
week9.AddGame(MIA, DET);
week9.AddGame(NO, CLE);
week9.AddGame(PHI, NYG);
week9.AddGame(WAS, LAR);
week9.AddGame(CAR, DEN);
week9.AddGame(LAC, HOU);
week9.AddGame(SF, LV);
week9.AddGame(NE, GB);
week9.AddGame(SEA, ARI);
...
week10.AddGame(CLE, HOU);
week10.AddGame(GB, MIN);
week10.AddGame(TEN, JAX);
week10.AddGame(IND, MIA);
week10.AddGame(NO, CAR);
week10.AddGame(NYJ, BUF);
week10.AddGame(LV, SEA);
week10.AddGame(ARI, LAR);
week10.AddGame(DAL, SF);
...
week11.AddGame(DAL, TEN);
week11.AddGame(DET, TB);
week11.AddGame(KC, ARI);
week11.AddGame(NYG, JAX);
week11.AddGame(CAR, BAL);
week11.AddGame(LAC, NYJ);
week11.AddGame(DEN, LV);
week11.AddGame(PHI, PIT);
...
week12.AddGame(DAL, PHI);
week12.AddGame(BUF, KC);
week12.AddGame(PIT, DEN);
week12.AddGame(CIN, NO);
week12.AddGame(CLE, LV);
week12.AddGame(IND, NYG);
week12.AddGame(MIA, NYJ);
week12.AddGame(MIN, ATL);
week12.AddGame(HOU, BAL);
week12.AddGame(JAX, TEN);
week12.AddGame(ARI, WAS);
week12.AddGame(SF, SEA);
...
week13.AddGame(CLE, CIN);
week13.AddGame(TEN, WAS);
week13.AddGame(NO, GB);
week13.AddGame(NYG, SF);
week13.AddGame(TB, LAC);
week13.AddGame(DEN, MIA);
week13.AddGame(ARI, PHI);
week13.AddGame(MIN, CAR);
week13.AddGame(NE, BUF);
...
week14.AddGame(MIA, CHI);
week14.AddGame(NYJ, DEN);
week14.AddGame(PHI, IND);
week14.AddGame(WAS, HOU);
week14.AddGame(CAR, NO);
week14.AddGame(BAL, TB);
week14.AddGame(LV, LAC);
week14.AddGame(CIN, KC);
week14.AddGame(SF, LAR);
week14.AddGame(SEA, NYG);
...
week15.AddGame(GB, MIA);
week15.AddGame(TEN, IND);
week15.AddGame(NYG, CLE);
week15.AddGame(PIT, BAL);
week15.AddGame(TB, NO);
week15.AddGame(WAS, ATL);
week15.AddGame(CAR, CIN);
week15.AddGame(HOU, JAX);
week15.AddGame(ARI, NYJ);
week15.AddGame(LV, DEN);
week15.AddGame(LAR, DAL);
...
week16.AddGame(SEA, LAR);
week16.AddGame(ATL, TB);
week16.AddGame(IND, CIN);
week16.AddGame(MIA, LAC);
week16.AddGame(MIN, WAS);
week16.AddGame(NO, ARI);
week16.AddGame(NYJ, NE);
week16.AddGame(PIT, CAR);
week16.AddGame(BAL, CLE);
week16.AddGame(LV, TEN);
week16.AddGame(KC, SF);
...
week17.AddGame(DAL, NYG);
week17.AddGame(TEN, PIT);
week17.AddGame(MIA, BUF);
week17.AddGame(NE, DEN);
week17.AddGame(NYJ, MIN);
week17.AddGame(LAC, KC);
week17.AddGame(TB, LAR);
week17.AddGame(CAR, SEA);
week17.AddGame(JAX, WAS);
week17.AddGame(ARI, LV);
week17.AddGame(CHI, DET);
...
week18.AddGame(CIN, CLE);
week18.AddGame(DEN, LAC);
week18.AddGame(GB, DET);
week18.AddGame(IND, JAX);
week18.AddGame(KC, LV);
week18.AddGame(LAR, SEA);
week18.AddGame(MIN, CHI);
week18.AddGame(NE, MIA);
week18.AddGame(NO, TB);
week18.AddGame(NYG, PHI);
week18.AddGame(ARI, SF);
week18.AddGame(WAS, DAL);
week18.AddGame(CAR, ATL);
week18.AddGame(BAL, PIT);
week18.AddGame(HOU, TEN);
  ...
  */
  ...
  function isBettingWindowOpen(currentDate) {
    ...
    const lastWeek = season.weeks[season.weeks.length - 1].weeks;
